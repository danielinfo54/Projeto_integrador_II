...
A plataforma permitirá que alunos, professores e funcionários registrem ocorrências relacionadas à estrutura, segurança, conservação e outras situações inadequadas que estejam acontecendo na escola. O usuário também poderá optar por realizar o relato de forma anônima.
...
- Registro da data da ocorrência;
...
As ocorrências poderão apresentar diferentes status:
